...
```{r Three mixtures of three, fig.height = 2}
...
```{r Layering the mixture, fig.height = 3}
...
```{r GP mountain range, out.width="50%", results='hide'}
# Specify the data.
GP_data <-
  df_mixture  %>%
...
```{r Three barcode plots, out.width="50%", results='hide'}
...
```{r Making of GP mountain range, out.width="100%"}
...
```{r Jaggedy covariance function, out.width="50%"}
